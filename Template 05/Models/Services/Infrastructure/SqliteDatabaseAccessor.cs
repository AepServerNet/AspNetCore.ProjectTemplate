...
using Polly;
using Template_SQLite_AdoNet_Crud_Polly.Models.Exceptions.Infrastructure;
using Template_SQLite_AdoNet_Crud_Polly.Models.Options;
using Template_SQLite_AdoNet_Crud_Polly.Models.ValueTypes;

namespace Template_SQLite_AdoNet_Crud_Polly.Models.Services.Infrastructure
{
    public class SqliteDatabaseAccessor : IDatabaseAccessor
    {
        ...
        private async Task<SqliteConnection> GetOpenedConnection(CancellationToken token)
        {
            ...
            var conn = new SqliteConnection("Data Source=Data/myDatabase.db; Mode=ReadWrite;");
            var policy = Policy
                .Handle<Exception>()
